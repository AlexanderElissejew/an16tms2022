...
import by.flowers.model.Bouquet;
import by.flowers.model.FlowerMarket;
...
public class Main {
        public static void main(String[] args) {
                ...
                System.out.println("Total amount: " +
                        (bouquetOne.getFlowersPrice() + bouquetSecond.getFlowersPrice() + bouquetThird.getFlowersPrice() +
                                bouquetFourth.getFlowersPrice() + bouquetFifth.getFlowersPrice()));
        }
